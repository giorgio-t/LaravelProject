...
<h1 style="font-size: 20px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;">We inform you we have just added {{ $product->getName() }} to the store!</h1>
...
<p><img src="{{ $message->embed('./storage/' . $product->getImage()) }}"></p>
